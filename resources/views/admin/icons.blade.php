	...
	<div class="col-sm-12">
		...
		<div class="row">
			<div class="fa col-lg-3">
				...
				<p>@include('admin.widgets.icon', array('class'=>'admin.home')) fa-home
			...
			<div class="fa col-lg-3">
				...
				<p>@include('admin.widgets.icon', array('class'=>'admin.table')) fa-table
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'admin.icons'))
