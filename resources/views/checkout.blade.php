                    ...
                    <div class="container">
                        @if (Session::has('bucket'))
                            ...
                            <h3 class="pro-title">Complete Order</h3>
                                ...
                                <ul class="list-group">
                                <form action="{{ url('client-profile/'.App\User::find(\Illuminate\Support\Facades\Session::get('User'))->client->id.'/postCheckout') }}" method="POST" id="cp_update" enctype="multipart/form-data" class="form-horizontal">
                                    {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text"  value="" class="form-control" name="cp_name" id="cp_name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" value="" class="form-control" name="cp_designation" id="cp_designation">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" value="" name="cp_telephone" id="cp_telephone" maxlength="12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-3">
