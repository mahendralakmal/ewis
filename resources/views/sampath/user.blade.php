...
@section('content')
    <div class="container-fluid orange-background">
        <div class="container white-background orange-gradiant-background">
            <div class=" col-md-12 profile-head">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                    <h5>Sampath Bank</h5>
                    <ul>
                        <li><span class="glyphicon glyphicon-home"></span> Sampath Bank PLC, No 110 , Sir James Peiris
                            Mawatha, Colombo 02, Sri Lanka.
                        </li>
                        <li><span class="glyphicon glyphicon-phone"></span> <a href="#" title="Phone">+94 11 2 30 30
                                50</a>
                        </li>
